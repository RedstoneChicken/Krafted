...
execute @a[hasitem={location=slot.weapon.mainhand,item=azc:neptunium_sword}] ~ ~ ~ detect ~ ~1 ~ water 0 scoreboard players add @s strengtheffect 1
execute @a[hasitem={location=slot.weapon.mainhand,item=azc:neptunium_axe}] ~ ~ ~ detect ~ ~1 ~ water 0 scoreboard players add @s strengtheffect 1
