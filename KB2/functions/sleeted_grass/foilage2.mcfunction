...
execute @e[type=ff:plant_growth,r=0,c=1] ~ ~ ~ detect ~2 ~1 ~1 air 0 execute @e[type=ff:plant_growth,r=0,c=1] ~ ~ ~ detect ~2 ~ ~1 ff:sleeted_grass_block 0 fill ~2 ~1 ~1 ~2 ~1 ~1 ff:snowy_grass_tall 0 replace air
...
execute @e[type=ff:plant_growth,r=0,c=1] ~ ~ ~ detect ~ ~1 ~-2 air 0 execute @e[type=ff:plant_growth,r=0,c=1] ~ ~ ~ detect ~ ~ ~-2 ff:sleeted_grass_block 0 fill ~ ~1 ~-2 ~ ~1 ~-2 ff:snowy_fern 0 replace air
